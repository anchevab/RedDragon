/*
  Melody with buzzer
  8-ohm speaker on digital pin 11
*/
#include "pitches.h"                // файл с нотите
#define buzzer 11                   // пин на зумера
...
void setup() {
  for (int thisNote = 0; thisNote < 8; thisNote++) {
    ...
    noTone(buzzer);                    // спиране на тоновете
  }
  digitalWrite(buzzer, HIGH);        //поставяме пина в HIGH,за да спре да свири
}
